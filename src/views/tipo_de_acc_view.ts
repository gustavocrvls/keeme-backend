...
export default {
  ...
  renderWithAccs(tipoDeAcc: TipoDeAcc) {
    return {
      id: tipoDeAcc.id,
      nome: tipoDeAcc.nome,
      pontos_por_unidade: tipoDeAcc.pontos_por_unidade,
  ...
  renderMinimal(tipoDeAcc: TipoDeAcc) {
    return {
      id: tipoDeAcc.id,
      nome: tipoDeAcc.nome,
      unidade_de_medida: unidadeDeMedidaView.render(tipoDeAcc.unidade_de_medida),
  ...
  renderManyWithAccs(tipoDeAcc: TipoDeAcc[]) {
    return tipoDeAcc.map(tipoDeAcc => this.renderWithAccs(tipoDeAcc))
  }
}
